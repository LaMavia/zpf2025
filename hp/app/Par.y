...
TypeArg
  ...
  | '(' ListTypeArg ')' { (uncurry Abs.BNFC'Position (tokenLineCol $1), Abs.TATup (uncurry Abs.BNFC'Position (tokenLineCol $1)) (snd $2)) }
...
Stmt
  ...
  | Modifier '(' ListTerm ')' ':' LIdent '(' ListTerm ')' { (fst $1, Abs.SMod (fst $1) (snd $1) (snd $3) (snd $6) (snd $8)) }
  | '(' Stmt '->' ListStmt ';' ListStmt ')' { (uncurry Abs.BNFC'Position (tokenLineCol $1), Abs.SIf (uncurry Abs.BNFC'Position (tokenLineCol $1)) (snd $2) (snd $4) (snd $6)) }
...
Term
  ...
  | '(' ListTerm ')' { (uncurry Abs.BNFC'Position (tokenLineCol $1), Abs.TTup (uncurry Abs.BNFC'Position (tokenLineCol $1)) (snd $2)) }
  | UIdent '(' ListTerm ')' { (fst $1, Abs.TConstr (fst $1) (snd $1) (snd $3)) }
