...
{-# INLINE happyOut14 #-}
newtype HappyWrap15 = HappyWrap15 ((Abs.BNFC'Position, Abs.Term))
happyIn15 :: ((Abs.BNFC'Position, Abs.Term)) -> (HappyAbsSyn )
happyIn15 x = Happy_GHC_Exts.unsafeCoerce# (HappyWrap15 x)
{-# INLINE happyIn15 #-}
happyOut15 :: (HappyAbsSyn ) -> HappyWrap15
happyOut15 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut15 #-}
newtype HappyWrap16 = HappyWrap16 ((Abs.BNFC'Position, [Abs.Term]))
happyIn16 :: ((Abs.BNFC'Position, [Abs.Term])) -> (HappyAbsSyn )
happyIn16 x = Happy_GHC_Exts.unsafeCoerce# (HappyWrap16 x)
{-# INLINE happyIn16 #-}
happyOut16 :: (HappyAbsSyn ) -> HappyWrap16
happyOut16 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut16 #-}
newtype HappyWrap17 = HappyWrap17 ((Abs.BNFC'Position, [Abs.Stmt]))
happyIn17 :: ((Abs.BNFC'Position, [Abs.Stmt])) -> (HappyAbsSyn )
...
happyExpList = HappyA# ""#

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_pProgram_internal","Integer","String","UIdent","LIdent","Program","ListDef","Def","TypeArg","ListTypeArg","DeclHeader","Stmt","Term","ListTerm","ListStmt","'('","')'","','","'.'","'.decl'","':'","':-'","'='","'False'","'True'","'['","']'","'_'","'|'","L_integ","L_quoted","L_UIdent","L_LIdent","%eof"]
...
happyActOffsets = HappyA# ""#

happyGotoOffsets :: HappyAddr
happyGotoOffsets = HappyA# ""#

happyAdjustOffset :: Happy_GHC_Exts.Int# -> Happy_GHC_Exts.Int#
happyAdjustOffset off = off

happyDefActions :: HappyAddr
happyDefActions = HappyA# ""#

happyCheck :: HappyAddr
happyCheck = HappyA# ""#

happyTable :: HappyAddr
happyTable = HappyA# ""#
...
happyNewToken action sts stk (tk:tks) =
	...
	PT _ (TI _) -> cont 15#;
	PT _ (TL _) -> cont 16#;
	PT _ (T_UIdent _) -> cont 17#;
	PT _ (T_LIdent _) -> cont 18#;
	_ -> happyError' ((tk:tks), [])
	}
